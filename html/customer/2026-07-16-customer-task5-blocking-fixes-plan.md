...
- [x] Viết domain/action tests cho double invoke, save/reload/same-QR replay, different-QR replacement, atomic validation của full replay bundle/context-swap/lifecycle-ledger, terminal prior tip và explicit switch sang generic.
