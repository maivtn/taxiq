...
- [x] Viết domain/action tests cho double invoke, save/reload/same-QR replay, different-QR replacement, tampered replay, terminal prior tip và explicit switch sang generic.
