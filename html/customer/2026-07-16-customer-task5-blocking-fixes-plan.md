...
- [x] Viết domain/action tests cho double invoke, save/reload/same-QR replay, different-QR replacement, atomic validation của intent shape/full replay bundle/context-swap/lifecycle-ledger, durable corrupt-state quarantine, terminal prior tip và explicit switch sang generic.
