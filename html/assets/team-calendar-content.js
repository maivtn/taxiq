...
window.NEXORA_TEAM_CALENDAR = {
  mount(host) {
    ...
    shadow.innerHTML = "<style>\n:host{--ink:#202331;--muted:#747a8c;--line:#e8e9f0;--bg:#f6f7fb;--card:#fff;--brand:#5b61e6;--brand-soft:#eef0ff;--green:#218b6b;--green-soft:#e9f7f1;--blue:#3975d4;--blue-soft:#edf4ff;--amber:#b56b14;--amber-soft:#fff5df;--red:#b74b55;--red-soft:#fff0f1;--slot:54px;--radius:16px}\n*{box-sizing:border-box}:host{margin:0;min-height:100%;font-family:\"DM Sans\",system-ui,sans-serif;color:var(--ink);background:var(--bg)}button,input,select{font:inherit}.app-shell{display:grid;grid-template-columns:232px minmax(0,1fr);min-height:100vh}.sidebar{position:sticky;top:0;height:100vh;background:#171926;color:#fff;padding:22px 14px;display:flex;flex-direction:column}.brand{display:flex;align-items:center;gap:11px;font-weight:700;font-size:15px;padding:0 8px 22px}.brand-mark,.mobile-logo{display:inline-grid;place-items:center;width:30px;height:30px;border-radius:9px;background:linear-gradient(145deg,#777df5,#4e53d8);color:#fff}.sidebar nav{display:flex;flex-direction:column;gap:3px}.sidebar nav a{color:#aeb2c2;text-decoration:none;padding:10px 12px;border-radius:9px;font-size:13px;display:flex;align-items:center;gap:10px}.sidebar nav a span{width:18px;text-align:center}.sidebar nav a:hover,.sidebar nav a.active{background:#292c3e;color:#fff}.sidebar-footer{margin-top:auto;border-top:1px solid #303345;padding:18px 8px 0;display:flex;gap:10px;align-items:center;font-size:11px}.sidebar-footer strong,.sidebar-footer small{display:block}.sidebar-footer small{color:#898e9f;margin-top:3px}.mini-avatar,.avatar{display:grid;place-items:center;border-radius:50%;background:#e7e8ff;color:#4f55c8;font-weight:700}.mini-avatar{width:34px;height:34px}.workspace{min-width:0;position:relative}.topbar{height:62px;background:rgba(255,255,255,.9);border-bottom:1px solid var(--line);display:flex;align-items:center;justify-content:space-between;padding:0 28px;position:sticky;top:0;z-index:10;backdrop-filter:blur(12px)}.topbar>div{display:flex;align-items:center;gap:10px}.profile button{border:0;background:transparent;font-size:20px;color:var(--muted)}.avatar{width:34px;height:34px;font-size:11px}.mobile-logo{display:none}.page-content{padding:26px 28px 34px;max-width:1700px;margin:auto}.intro{display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:22px}.eyebrow{font-size:11px;letter-spacing:.14em;color:var(--brand);font-weight:700;margin:0 0 8px}.intro h1{font-size:28px;letter-spacing:-.04em;margin:0}.subtitle{color:var(--muted);font-size:13px;margin:7px 0 0}.primary-button{border:0;border-radius:10px;background:var(--brand);color:#fff;padding:11px 16px;font-weight:600;font-size:13px;box-shadow:0 7px 18px rgba(91,97,230,.24);cursor:pointer}.datebar{display:flex;align-items:center;gap:18px;margin-bottom:14px}.datebar>div:nth-child(2){display:flex;flex-direction:column;min-width:190px}.datebar strong{font-size:14px}.datebar span{font-size:11px;color:var(--muted);margin-top:2px}.date-controls,.view-switch{display:flex;background:#fff;border:1px solid var(--line);padding:3px;border-radius:10px}.date-controls button,.view-switch button{border:0;background:transparent;color:var(--muted);height:30px;padding:0 10px;border-radius:7px;cursor:pointer;font-size:12px}.date-controls button:first-child,.date-controls button:last-child{font-size:20px}.view-switch{margin-left:auto}.view-switch button.active{background:var(--brand-soft);color:var(--brand);font-weight:600}.summary{display:grid;grid-template-columns:1.55fr repeat(4,1fr);gap:10px;margin-bottom:14px}.summary-card{min-width:0;border:1px solid var(--line);background:var(--card);border-radius:var(--radius);padding:16px;text-align:left;cursor:pointer;transition:.18s ease;position:relative;overflow:hidden}.summary-card:hover{transform:translateY(-1px);box-shadow:0 8px 24px rgba(38,41,56,.07)}.summary-card.is-active{border-color:var(--brand);box-shadow:0 0 0 3px rgba(91,97,230,.1)}.summary-card strong{display:block;font-size:25px;letter-spacing:-.04em}.summary-card:first-child strong{font-size:34px}.summary-card span{display:block;color:var(--muted);font-size:11px;margin-top:4px}.summary-card small{display:block;color:var(--green);font-size:11px;margin-top:8px}.summary-card .status-icon{position:absolute;right:14px;top:14px;width:28px;height:28px;border-radius:9px;display:grid;place-items:center;font-size:12px}.status-icon.completed{background:var(--green-soft);color:var(--green)}.status-icon.upcoming{background:var(--blue-soft);color:var(--blue)}.status-icon.pending{background:var(--amber-soft);color:var(--amber)}.status-icon.cancelled{background:var(--red-soft);color:var(--red)}.calendar-panel{background:var(--card);border:1px solid var(--line);border-radius:var(--radius);overflow:hidden}.calendar-toolbar{height:58px;border-bottom:1px solid var(--line);display:flex;align-items:center;padding:0 14px;gap:10px}.search-field{display:flex;align-items:center;gap:7px;border:1px solid var(--line);border-radius:9px;padding:0 10px;height:35px;width:250px;color:var(--muted)}.search-field input{border:0;outline:0;width:100%;font-size:12px}.calendar-toolbar select{height:35px;border:1px solid var(--line);border-radius:9px;background:#fff;padding:0 30px 0 10px;font-size:12px;color:var(--ink)}#mobile-technician{display:none}.legend{margin-left:auto;display:flex;gap:13px;font-size:11px;color:var(--muted)}.legend span{display:flex;align-items:center;gap:5px}.dot{width:7px;height:7px;border-radius:50%}.dot.completed{background:var(--green)}.dot.upcoming{background:var(--blue)}.dot.pending{background:var(--amber)}.calendar-viewport{overflow:auto;max-height:630px}.calendar-grid{display:grid;grid-template-columns:70px repeat(var(--tech-count),180px);grid-template-rows:64px repeat(20,var(--slot));min-width:max-content;position:relative}.corner{position:sticky;top:0;left:0;z-index:8;background:#fbfbfd;border-right:1px solid var(--line);border-bottom:1px solid var(--line)}.technician-header{position:sticky;top:0;z-index:6;background:rgba(251,251,253,.96);border-right:1px solid var(--line);border-bottom:1px solid var(--line);padding:12px;display:flex;align-items:center;gap:9px;backdrop-filter:blur(8px)}.tech-avatar{width:32px;height:32px;border-radius:10px;background:linear-gradient(145deg,#f0edff,#e4e7ff);display:grid;place-items:center;font-size:11px;color:#555bc7;font-weight:700}.tech-meta{min-width:0}.tech-name{font-size:12px;font-weight:600;white-space:nowrap}.tech-meta small{display:flex;align-items:center;gap:4px;color:var(--muted);font-size:11px;margin-top:3px}.online{width:5px;height:5px;background:#4eb58c;border-radius:50%}.time-cell{position:sticky;left:0;z-index:4;background:#fff;border-right:1px solid var(--line);border-bottom:1px solid #f0f1f5;padding:8px 10px;text-align:right;color:var(--muted);font-size:11px}.slot-cell{border-right:1px solid var(--line);border-bottom:1px solid #f0f1f5;background-image:linear-gradient(to bottom,transparent 50%,#f6f6f9 50%);background-size:100% 27px}.appointment{z-index:3;margin:3px 5px;border-radius:8px;padding:7px 8px;border-left:3px solid;overflow:hidden;cursor:pointer;box-shadow:0 2px 7px rgba(27,30,47,.05);transition:.15s ease}.appointment:hover{transform:translateY(-1px);box-shadow:0 6px 12px rgba(27,30,47,.1)}.appointment.completed{background:var(--green-soft);border-color:var(--green);color:#176a51}.appointment.upcoming{background:var(--blue-soft);border-color:var(--blue);color:#295da9}.appointment.pending{background:var(--amber-soft);border-color:var(--amber);color:#8b5410}.appointment.cancelled{background:var(--red-soft);border-color:var(--red);color:#913942;opacity:.72}.appointment strong,.appointment span{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.appointment strong{font-size:11px}.appointment span{font-size:11px;margin-top:3px;opacity:.85}.drawer-backdrop{position:fixed;inset:0;background:rgba(24,27,40,.18);opacity:0;visibility:hidden;transition:.2s;z-index:20}.drawer-backdrop.is-open{opacity:1;visibility:visible}.drawer{position:fixed;z-index:21;right:0;top:0;height:100vh;width:390px;background:#fff;box-shadow:-18px 0 50px rgba(27,30,47,.13);transform:translateX(105%);transition:.25s ease;padding:24px}.drawer.drawer--open{transform:translateX(0)}.drawer-head{display:flex;justify-content:space-between;align-items:center;padding-bottom:18px;border-bottom:1px solid var(--line)}.drawer-head h2{font-size:18px;margin:0}.close-button{width:34px;height:34px;border:1px solid var(--line);border-radius:9px;background:#fff;cursor:pointer}.customer-card{display:flex;gap:12px;align-items:center;background:var(--bg);border-radius:13px;padding:14px;margin:20px 0}.customer-avatar{width:42px;height:42px;border-radius:13px;background:var(--brand-soft);color:var(--brand);display:grid;place-items:center;font-weight:700}.customer-card strong,.customer-card span{display:block}.customer-card span{font-size:11px;color:var(--muted);margin-top:3px}.detail-list{display:grid;gap:18px}.detail-row{display:grid;grid-template-columns:110px 1fr;font-size:12px}.detail-row span:first-child{color:var(--muted)}.status-pill{display:inline-flex;width:max-content;padding:5px 8px;border-radius:999px;font-size:11px;font-weight:600}.status-pill.completed{background:var(--green-soft);color:var(--green)}.status-pill.upcoming{background:var(--blue-soft);color:var(--blue)}.status-pill.pending{background:var(--amber-soft);color:var(--amber)}.status-pill.cancelled{background:var(--red-soft);color:var(--red)}.empty-state{grid-column:2/-1;padding:50px;text-align:center;color:var(--muted);font-size:12px}\n@media(max-width:1050px){.app-shell{grid-template-columns:76px minmax(0,1fr)}.sidebar{padding:22px 10px}.brand span:last-child,.sidebar nav a:not(.active){font-size:0}.sidebar nav a span{font-size:15px}.sidebar nav a{justify-content:center}.sidebar nav a.active{font-size:0}.sidebar-footer>div:last-child{display:none}.summary{grid-template-columns:1.4fr repeat(4,1fr)}.summary-card{padding:13px}.legend{display:none}}\n@media(max-width:760px){.app-shell{display:block}.sidebar{display:none}.topbar{padding:0 16px}.mobile-logo{display:inline-grid;width:28px;height:28px}.page-content{padding:18px 14px 28px}.intro{align-items:flex-start}.intro h1{font-size:23px}.subtitle{max-width:210px}.primary-button{font-size:0;padding:10px;width:38px;height:38px}.primary-button:first-letter{font-size:18px}.datebar{gap:9px;flex-wrap:wrap}.datebar>div:nth-child(2){min-width:150px}.view-switch{display:none}.summary{display:flex;overflow-x:auto;padding:3px 2px 8px;scrollbar-width:none}.summary-card{min-width:142px}.summary-card:first-child{min-width:190px}.calendar-toolbar{height:auto;padding:10px;flex-wrap:wrap}.search-field{width:100%}#technician-filter{display:none}#mobile-technician{display:block;width:100%}.calendar-viewport{max-height:590px}.calendar-grid{grid-template-columns:62px minmax(260px,calc(100vw - 92px))}.drawer{width:100%;padding:20px}}\n\n.calendar-toolbar.overview-mode .search-field,.calendar-toolbar.overview-mode select{display:none}.calendar-toolbar.overview-mode:before{content:\"BOOKING LOAD BY DAY\";font-size:11px;letter-spacing:.12em;font-weight:700;color:var(--muted)}.overview-grid{min-width:850px}.overview-weekdays{display:grid;grid-template-columns:repeat(7,1fr);background:#fbfbfd;border-bottom:1px solid var(--line);position:sticky;top:0;z-index:4}.overview-weekdays span{padding:12px;text-align:center;color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;border-right:1px solid var(--line)}.overview-days{display:grid;grid-template-columns:repeat(7,1fr)}.overview-day{border:0;border-right:1px solid var(--line);border-bottom:1px solid var(--line);background:#fff;min-height:150px;padding:13px;text-align:left;cursor:pointer;transition:.16s}.overview-day:hover{background:#fafaff;box-shadow:inset 0 0 0 2px var(--brand-soft)}.overview-day.outside-month{background:#fafafa;opacity:.5}.overview-day-head{display:flex;justify-content:space-between;align-items:center}.overview-day-head span{font-size:11px;color:var(--muted);font-weight:600}.overview-day-head strong{font-size:21px}.capacity-track{height:5px;background:#edf0f5;border-radius:99px;overflow:hidden;margin:13px 0 6px}.capacity-track i{display:block;width:var(--load);height:100%;border-radius:inherit;background:linear-gradient(90deg,#777df5,#555bdc)}.capacity-label{display:flex;justify-content:space-between;color:var(--muted);font-size:11px}.day-footer{display:flex;justify-content:space-between;border-top:1px solid #f0f1f5;margin-top:20px;padding-top:9px;font-size:11px;color:var(--muted)}.day-footer strong{font-size:11px;color:var(--ink)}.day-preview{display:grid;gap:6px;margin:13px 0}.day-preview>div{display:grid;grid-template-columns:6px 42px 1fr;gap:5px;align-items:center;font-size:11px}.day-preview i{width:5px;height:5px;border-radius:50%;background:var(--blue)}.day-preview i.completed{background:var(--green)}.day-preview i.pending{background:var(--amber)}.day-preview i.cancelled{background:var(--red)}.day-preview span{color:var(--muted)}.day-preview strong{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.overview-grid.week .overview-day{min-height:250px}.overview-grid.twoWeeks .overview-day{min-height:170px}.overview-grid.threeWeeks .overview-day,.overview-grid.month .overview-day{min-height:140px}.view-switch{overflow-x:auto;max-width:480px}.view-switch button{white-space:nowrap}\n@media(max-width:760px){.datebar .view-switch{display:flex;order:3;margin:2px 0 0;width:100%;max-width:100%;scrollbar-width:none}.overview-grid{min-width:720px}.overview-day{min-height:135px;padding:10px}.calendar-toolbar.overview-mode{height:44px}.calendar-toolbar.overview-mode .legend{display:flex;margin-left:auto}.overview-day-head strong{font-size:18px}.day-footer{margin-top:14px}}\n\n.drawer{width:460px;overflow-y:auto}.customer-identity{flex:1;min-width:0}.customer-identity>div{display:flex;align-items:center;gap:8px}.guest-badge{display:inline-flex!important;width:max-content;padding:4px 7px;border-radius:999px;font-size:11px!important;font-weight:700;letter-spacing:.03em;margin:0!important}.guest-badge.returning{background:#e9f7f1;color:var(--green)}.guest-badge.new{background:var(--blue-soft);color:var(--blue)}.detail-list.compact{gap:12px}.total-row{border-top:1px solid var(--line);padding-top:12px}.total-row strong{font-size:15px}.intelligence{border-top:1px solid var(--line);margin-top:20px;padding-top:19px}.section-title{display:flex;align-items:center;justify-content:space-between}.section-title>div{display:flex;align-items:center;gap:7px;font-size:13px}.section-title i{width:24px;height:24px;border-radius:8px;background:var(--brand-soft);display:grid;place-items:center;color:var(--brand);font-style:normal}.section-title>span{font-size:11px;color:var(--muted)}.intel-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin:13px 0}.intel-stats>div{background:var(--bg);border:1px solid #eff0f5;border-radius:10px;padding:10px;min-width:0}.intel-stats strong,.intel-stats span{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.intel-stats strong{font-size:12px}.intel-stats span{font-size:11px;color:var(--muted);margin-top:3px}.history-head{display:flex;justify-content:space-between;align-items:center;margin:16px 0 8px}.history-head strong{font-size:11px}.history-head span{font-size:11px;color:var(--muted)}.service-history{border:1px solid var(--line);border-radius:10px;overflow:hidden}.service-history>div{display:grid;grid-template-columns:42px 1fr 32px;gap:8px;align-items:center;padding:9px;border-bottom:1px solid var(--line);font-size:11px}.service-history>div:last-child{border-bottom:0}.service-history>div>span,.service-history small{color:var(--muted)}.service-history strong,.service-history small{display:block}.service-history b{text-align:right}.smart-recommendation{margin-top:14px;border:1px solid #dfe1ff;background:linear-gradient(145deg,#f8f8ff,#f0f2ff);border-radius:12px;padding:13px}.smart-recommendation.is-added{border-color:#bfe7d8;background:var(--green-soft)}.recommendation-top{display:flex;justify-content:space-between;color:var(--brand);font-size:11px;font-weight:700;letter-spacing:.08em}.recommendation-top i{font-style:normal}.recommendation-main{display:flex;justify-content:space-between;align-items:center;margin-top:9px}.recommendation-main strong,.recommendation-main span{display:block}.recommendation-main strong{font-size:14px}.recommendation-main span{font-size:11px;color:var(--muted);margin-top:2px}.recommendation-main>b{font-size:15px}.smart-recommendation p{font-size:11px;line-height:1.45;color:#5e6375;margin:9px 0 12px}.recommendation-actions{display:flex;gap:7px}.recommendation-actions button{border-radius:8px;padding:8px 10px;font-size:11px;font-weight:600;cursor:pointer}.add-upsell{border:0;background:var(--brand);color:#fff}.add-upsell:disabled{background:var(--green)}.dismiss-upsell{border:1px solid var(--line);background:#fff;color:var(--muted)}.dismissed-note,.insight-note,.no-history{margin-top:13px;padding:12px;border-radius:10px;background:var(--bg);font-size:11px;color:var(--muted)}.no-history{display:grid;grid-template-columns:28px 1fr;gap:2px 8px;align-items:center}.no-history i{grid-row:1/3;width:28px;height:28px;border-radius:9px;background:#fff;display:grid;place-items:center;font-style:normal}.no-history strong,.no-history span{display:block}.no-history strong{color:var(--ink)}\n@media(max-width:760px){.drawer{width:100%;padding:18px}.intel-stats{grid-template-columns:repeat(3,minmax(0,1fr))}}\n\n.intro-actions{display:flex;gap:9px}.secondary-button{border:1px solid var(--line);border-radius:10px;background:#fff;color:var(--ink);padding:10px 14px;font-size:12px;font-weight:600;cursor:pointer}.secondary-button:hover{border-color:#cfd2e5;background:#fafaff}.technician-overview{background:#fff;border:1px solid var(--line);border-radius:var(--radius);margin-bottom:14px;overflow:hidden}.overview-title{display:flex;justify-content:space-between;align-items:center;padding:15px 17px;border-bottom:1px solid var(--line)}.overview-title h2{font-size:16px;margin:0}.overview-title>div>span{font-size:11px;color:var(--muted)}.policy-chip{display:flex!important;align-items:center;gap:8px;background:var(--green-soft);border-radius:10px;padding:8px 10px}.policy-chip>i{color:var(--green);font-size:11px}.policy-chip span,.policy-chip strong,.policy-chip small{display:block}.policy-chip strong{font-size:11px}.policy-chip small{font-size:11px;color:var(--green);margin-top:2px}.tech-overview-head,.tech-overview-row{display:grid;grid-template-columns:minmax(165px,1.5fr) repeat(5,minmax(78px,.75fr)) 76px 20px;align-items:center;gap:8px;padding:9px 15px}.tech-overview-head{background:#fafafd;border-bottom:1px solid var(--line);font-size:11px;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:.06em}.tech-overview-body{max-height:255px;overflow:auto}.tech-overview-row{width:100%;border:0;border-bottom:1px solid #f0f1f5;background:#fff;text-align:left;cursor:pointer;font-size:11px;color:var(--ink)}.tech-overview-row:hover{background:#fafaff}.tech-cell{display:flex;align-items:center;gap:8px;min-width:0}.tech-cell .tech-avatar{width:29px;height:29px;flex:0 0 auto;font-style:normal}.tech-cell span,.tech-cell strong,.tech-cell small{display:block;min-width:0}.tech-cell small{color:var(--muted);font-size:11px;margin-top:2px}.reward-value{color:var(--green)}.ledger-status{display:inline-flex;width:max-content;padding:4px 7px;border-radius:999px;font-size:11px;font-weight:700}.ledger-status.earned{background:var(--green-soft);color:var(--green)}.ledger-status.reversed{background:var(--red-soft);color:var(--red)}.row-arrow{font-style:normal;color:var(--muted);font-size:17px}.policy-drawer{position:fixed;z-index:31;top:0;right:0;width:620px;height:100vh;background:#fff;box-shadow:-20px 0 55px rgba(27,30,47,.16);transform:translateX(105%);transition:.25s ease;display:flex;flex-direction:column}.policy-drawer.is-open{transform:translateX(0)}#policy-backdrop{z-index:30}.policy-head{display:flex;justify-content:space-between;align-items:flex-start;padding:22px 24px;border-bottom:1px solid var(--line)}.policy-head h2{font-size:21px;margin:0}.policy-head>div>span{font-size:11px;color:var(--muted)}.close-policy{width:34px;height:34px;border:1px solid var(--line);border-radius:9px;background:#fff;cursor:pointer}.policy-scroll{overflow-y:auto;padding:0 24px 24px}.policy-section{padding:20px 0;border-bottom:1px solid var(--line)}.policy-section-title{display:flex;gap:10px;align-items:flex-start;margin-bottom:13px}.policy-section-title>span{width:22px;height:22px;border-radius:7px;background:var(--brand-soft);color:var(--brand);display:grid;place-items:center;font-size:11px;font-weight:700}.policy-section-title strong,.policy-section-title small{display:block}.policy-section-title strong{font-size:12px}.policy-section-title small{font-size:11px;color:var(--muted);margin-top:2px}.choice-cards{display:grid;grid-template-columns:1fr 1fr;gap:8px}.choice-card{display:flex;align-items:center;gap:9px;border:1px solid var(--line);border-radius:11px;padding:11px;cursor:pointer}.choice-card:has(input:checked){border-color:var(--brand);background:var(--brand-soft)}.choice-card input{accent-color:var(--brand)}.choice-card span,.choice-card strong,.choice-card small{display:block}.choice-card strong{font-size:11px}.choice-card small{font-size:11px;color:var(--muted);margin-top:2px}.segmented{display:grid;grid-template-columns:repeat(3,1fr);padding:3px;background:var(--bg);border-radius:9px;margin-bottom:13px}.segmented button{border:0;background:transparent;border-radius:7px;padding:8px;font-size:11px;color:var(--muted);cursor:pointer}.segmented button.active{background:#fff;color:var(--brand);font-weight:700;box-shadow:0 2px 7px rgba(32,35,49,.08)}.structure-panel{background:#fafafd;border:1px solid var(--line);border-radius:11px;padding:12px}.structure-panel[hidden],.policy-section[hidden]{display:none}.field-label{display:grid;gap:6px;font-size:11px;color:var(--muted)}.money-input{display:flex;align-items:center;border:1px solid var(--line);border-radius:8px;background:#fff;overflow:hidden}.money-input span{padding-left:9px;color:var(--muted);font-size:11px}.money-input input{border:0;outline:0;width:100%;padding:8px;font-size:11px}.level-panel{display:grid;gap:7px}.level-rate{display:grid;grid-template-columns:1fr 100px;align-items:center;gap:10px}.level-rate span,.level-rate strong,.level-rate small{display:block}.level-rate strong{font-size:11px}.level-rate small{font-size:11px;color:var(--muted);margin-top:2px}.tier-method{display:flex;gap:15px;font-size:11px;margin-bottom:10px}.tier-method input{accent-color:var(--brand)}#tier-editor{display:grid;gap:7px}.tier-row{display:grid;grid-template-columns:22px 1fr 1fr 1fr 18px 25px;gap:6px;align-items:end}.tier-number{width:22px;height:22px;border-radius:6px;background:var(--brand-soft);display:grid;place-items:center;font-size:11px;color:var(--brand);margin-bottom:5px}.tier-row label{display:grid;gap:3px;font-size:11px;color:var(--muted)}.tier-row input{min-width:0;border:1px solid var(--line);border-radius:7px;padding:7px;font-size:11px}.money-prefix{margin-bottom:8px;color:var(--muted);font-size:11px}.remove-tier{border:0;background:transparent;color:var(--red);font-size:15px;margin-bottom:3px;cursor:pointer}.add-tier{border:1px dashed #cfd2e5;background:#fff;border-radius:8px;width:100%;padding:8px;margin-top:9px;color:var(--brand);font-size:11px;font-weight:600;cursor:pointer}.field-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.field-grid label{display:grid;gap:5px;color:var(--muted);font-size:11px}.field-grid select,.field-grid input{border:1px solid var(--line);border-radius:8px;background:#fff;padding:8px;font-size:11px;color:var(--ink)}.override-list{display:grid;gap:6px}.override-row{display:grid;grid-template-columns:1.5fr 90px 90px 80px;gap:7px;align-items:center;background:#fafafd;border-radius:9px;padding:7px}.override-row select{border:1px solid var(--line);border-radius:7px;background:#fff;padding:7px;font-size:11px}.preview-card{display:flex;align-items:center;justify-content:space-between;margin:16px 0;background:linear-gradient(145deg,#f7f7ff,#edf0ff);border:1px solid #dfe1ff;border-radius:12px;padding:14px}.preview-card span,.preview-card strong,.preview-card small{display:block}.preview-card span{font-size:11px;color:var(--brand);font-weight:700;letter-spacing:.08em}.preview-card strong{font-size:17px;margin-top:4px}.preview-card small{font-size:11px;color:var(--muted);margin-top:3px}.preview-card>i{font-style:normal;color:var(--brand);font-size:20px}.audit-card{padding:0 0 10px}.audit-card>strong{font-size:11px}.audit-card>div{display:flex;gap:8px;margin-top:9px}.audit-card>div>i{width:18px;height:18px;border-radius:6px;background:var(--green-soft);color:var(--green);display:grid;place-items:center;font-style:normal;font-size:11px}.audit-card span,.audit-card strong,.audit-card small{display:block}.audit-card strong{font-size:11px}.audit-card small{font-size:11px;color:var(--muted);margin-top:2px}.policy-footer{margin-top:auto;border-top:1px solid var(--line);padding:13px 20px;display:flex;align-items:center;gap:8px}.policy-footer>span{margin-right:auto;font-size:11px;color:var(--green)}.policy-footer>span.error{color:var(--red)}.policy-footer button{border-radius:8px;padding:9px 12px;font-size:11px;font-weight:600;cursor:pointer}.cancel-policy{border:1px solid var(--line);background:#fff}.policy-footer #save-policy{border:0;background:var(--brand);color:#fff}.policy-footer #save-policy:disabled{opacity:.4;cursor:not-allowed}.ledger-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;margin:18px 0}.ledger-summary>div{background:var(--bg);border-radius:10px;padding:11px}.ledger-summary strong,.ledger-summary span{display:block}.ledger-summary strong{font-size:15px}.ledger-summary span{font-size:11px;color:var(--muted);margin-top:2px}.ledger-rule{display:flex;justify-content:space-between;padding:10px;border:1px solid var(--line);border-radius:9px;font-size:11px}.ledger-rule span{color:var(--muted)}.ledger-list{margin-top:15px;border:1px solid var(--line);border-radius:10px;overflow:hidden}.ledger-list-head,.ledger-row{display:grid;grid-template-columns:1fr 95px;gap:10px;padding:9px 10px}.ledger-list-head{background:#fafafd;color:var(--muted);font-size:11px}.ledger-row{border-top:1px solid var(--line)}.ledger-row>span:last-child{text-align:right}.ledger-row strong,.ledger-row small{display:block}.ledger-row strong{font-size:11px}.ledger-row small{font-size:11px;color:var(--muted);margin-top:2px}.ledger-row i{font-style:normal}.ledger-row i.earned{color:var(--green)}.ledger-row i.reversed{color:var(--red)}.ledger-row i.pending{color:var(--amber)}.ledger-total{display:flex;justify-content:space-between;margin-top:12px;padding:12px;background:var(--green-soft);border-radius:9px;font-size:11px;color:var(--green)}\n@media(max-width:760px){.intro-actions{gap:6px}.intro-actions .secondary-button{font-size:0;width:38px;height:38px;padding:0}.intro-actions .secondary-button:first-letter{font-size:16px}.technician-overview{overflow:visible}.overview-title{align-items:flex-start}.policy-chip{display:none!important}.tech-overview-head{display:none}.tech-overview-body{display:grid;gap:8px;padding:9px;max-height:340px}.tech-overview-row{grid-template-columns:1fr 1fr 1fr;padding:10px;border:1px solid var(--line);border-radius:10px;gap:10px}.tech-overview-row .tech-cell{grid-column:1/3}.tech-overview-row .row-arrow{grid-column:3;grid-row:1;text-align:right}.tech-overview-row>strong,.tech-overview-row>span:not(.tech-cell){font-size:11px}.policy-drawer{width:100%}.policy-head{padding:18px}.policy-scroll{padding:0 14px 18px}.choice-cards,.field-grid{grid-template-columns:1fr}.tier-row{grid-template-columns:22px 1fr 1fr;align-items:end}.tier-row label:nth-of-type(3){grid-column:2/3}.tier-row .money-prefix{display:none}.tier-row .remove-tier{grid-column:3;grid-row:2}.override-row{grid-template-columns:1fr 95px}.override-row .money-input,.override-row [data-override-turn]{grid-row:2}.policy-footer{padding:11px}.policy-footer>span{max-width:120px}.drawer{width:100%}}\n\n.unassigned-queue{background:#fff;border:1px solid var(--line);border-radius:var(--radius);margin-bottom:14px;overflow:hidden}.queue-head{display:flex;justify-content:space-between;align-items:center;padding:15px 17px;border-bottom:1px solid var(--line)}.queue-head h2{font-size:15px;margin:0}.queue-head h2 span{display:inline-grid;place-items:center;width:23px;height:23px;border-radius:8px;background:var(--amber-soft);color:var(--amber);margin-right:5px}.queue-head small{font-size:11px;color:var(--muted)}.assignment-notice{background:var(--green-soft);color:var(--green);border-radius:8px;padding:8px 10px;font-size:11px}.queue-list{display:grid}.queue-card{display:grid;grid-template-columns:85px minmax(150px,1fr) minmax(230px,1.5fr) 215px;align-items:center;gap:12px;padding:12px 16px;border-bottom:1px solid #f0f1f5}.queue-card:last-child{border-bottom:0}.queue-card.urgent{box-shadow:inset 3px 0 var(--amber);background:#fffdf8}.queue-time strong,.queue-time span{display:block}.queue-time strong{font-size:12px}.queue-time span{font-size:11px;color:var(--muted);margin-top:2px}.queue-customer strong,.queue-customer small{display:block}.queue-customer strong{font-size:11px;margin-top:5px}.queue-customer small{font-size:11px;color:var(--muted);margin-top:2px}.source-badge{display:inline-flex!important;width:max-content;border-radius:999px;padding:3px 6px;font-size:11px!important;font-style:normal;font-weight:700;margin-top:5px}.source-badge.anyone{background:var(--amber-soft);color:var(--amber)}.source-badge.requested{background:var(--green-soft);color:var(--green)}.suggested-tech{display:flex;align-items:center;gap:8px}.suggested-tech .tech-avatar{width:31px;height:31px;flex:0 0 auto}.suggested-tech span,.suggested-tech strong,.suggested-tech small,.suggested-tech em{display:block}.suggested-tech small{font-size:11px;color:var(--muted)}.suggested-tech strong{font-size:11px;margin-top:2px}.suggested-tech em{font-size:11px;color:var(--green);font-style:normal;margin-top:2px}.queue-actions{display:flex;gap:6px}.queue-actions button{border-radius:8px;padding:8px 10px;font-size:11px;font-weight:600;cursor:pointer}.assign-suggested{border:0;background:var(--brand);color:#fff}.view-technicians{border:1px solid var(--line);background:#fff;color:var(--muted)}.queue-empty{display:flex;align-items:center;justify-content:center;gap:9px;padding:18px}.queue-empty>i{width:29px;height:29px;border-radius:10px;background:var(--green-soft);color:var(--green);display:grid;place-items:center;font-style:normal}.queue-empty span,.queue-empty strong,.queue-empty small{display:block}.queue-empty strong{font-size:11px}.queue-empty small{font-size:11px;color:var(--muted);margin-top:2px}.assignment-choices{display:grid;gap:7px}.assignment-choice{display:flex;gap:8px;align-items:center;border:1px solid var(--line);border-radius:10px;padding:10px;cursor:pointer}.assignment-choice:has(input:checked){border-color:var(--brand);background:var(--brand-soft)}.assignment-choice input{accent-color:var(--brand)}.assignment-choice span,.assignment-choice strong,.assignment-choice small{display:block}.assignment-choice strong{font-size:11px}.assignment-choice small{font-size:11px;color:var(--muted);margin-top:2px}.assignment-rule-row{display:grid;grid-template-columns:155px 1fr;gap:9px;margin-top:10px}.assignment-rule-row>label{display:grid;gap:5px;font-size:11px;color:var(--muted)}.assignment-rule-row select{border:1px solid var(--line);border-radius:8px;background:#fff;padding:8px;font-size:11px}.fairness-rule{display:flex;gap:8px;align-items:center;background:var(--green-soft);border-radius:9px;padding:9px}.fairness-rule>i{width:21px;height:21px;border-radius:7px;background:#fff;color:var(--green);display:grid;place-items:center;font-style:normal}.fairness-rule span,.fairness-rule strong,.fairness-rule small{display:block}.fairness-rule strong{font-size:11px;color:var(--green)}.fairness-rule small{font-size:11px;color:#477866;margin-top:2px}.drawer-head>div>span{font-size:11px;color:var(--muted)}.picker-rule{display:flex;gap:8px;background:var(--brand-soft);border-radius:10px;padding:10px;margin:17px 0}.picker-rule>i{font-style:normal;color:var(--brand)}.picker-rule span,.picker-rule strong,.picker-rule small{display:block}.picker-rule strong{font-size:11px}.picker-rule small{font-size:11px;color:var(--muted);margin-top:2px}.candidate-list{display:grid;gap:6px}.candidate-row{display:grid;grid-template-columns:20px 32px 1fr 55px 65px;gap:8px;align-items:center;border:1px solid var(--line);border-radius:10px;background:#fff;padding:9px;text-align:left;cursor:pointer}.candidate-row:not(:disabled):hover{border-color:var(--brand);background:#fafaff}.candidate-row:disabled{opacity:.48;cursor:not-allowed}.candidate-row .rank{font-size:11px;color:var(--muted);text-align:center}.candidate-row .tech-avatar{width:30px;height:30px}.candidate-main strong,.candidate-main small,.candidate-score strong,.candidate-score small{display:block}.candidate-main strong{font-size:11px}.candidate-main small{font-size:11px;color:var(--muted);margin-top:2px}.candidate-score{text-align:right}.candidate-score strong{font-size:11px}.candidate-score small{font-size:11px;color:var(--muted)}.eligibility{border-radius:999px;padding:4px 6px;text-align:center;font-size:11px;font-weight:700}.eligibility.eligible{background:var(--green-soft);color:var(--green)}.eligibility.ineligible{background:var(--red-soft);color:var(--red)}.attribution-ledger .ledger-row>span:first-child{display:flex;flex-direction:column;align-items:flex-start}.attribution-ledger .ledger-row>span:last-child small{margin-top:3px}\n@media(max-width:900px){.queue-card{grid-template-columns:75px 1fr 1.3fr}.queue-actions{grid-column:2/4}.queue-actions button{flex:1}}\n@media(max-width:760px){.queue-head{align-items:flex-start}.assignment-notice{display:none}.queue-card{grid-template-columns:68px 1fr;padding:11px}.suggested-tech,.queue-actions{grid-column:1/3}.queue-actions button{flex:1}.assignment-rule-row{grid-template-columns:1fr}.candidate-row{grid-template-columns:18px 30px 1fr 58px}.candidate-score{display:none}.candidate-row .eligibility{grid-column:4}.attribution-ledger .ledger-list-head,.attribution-ledger .ledger-row{grid-template-columns:1fr 110px}}\n\n.language-switch{display:flex;align-items:center;padding:3px;background:#f0f1f6;border:1px solid var(--line);border-radius:9px}.language-switch button{min-width:31px;height:27px;padding:0 7px;border:0;border-radius:7px;background:transparent;color:var(--muted);font-size:11px;font-weight:700;cursor:pointer}.language-switch button.active{background:#fff;color:var(--brand);box-shadow:0 2px 7px rgba(32,35,49,.1)}\n@media(max-width:760px){.language-switch button{min-width:29px;padding:0 5px}}\n\n\n:host{display:block;min-width:0}:host([hidden]){display:none} .page-content{max-width:none;padding:16px 0 24px}\n</style><section class=\"workspace\" aria-label=\"Team Calendar\">\n\n      <div class=\"page-content\">\n        \n\n        <div class=\"datebar\">\n          <div class=\"date-controls\"><button id=\"prev-day\" aria-label=\"Previous day\">‹</button><button id=\"today-button\">Today</button><button id=\"next-day\" aria-label=\"Next day\">›</button></div>\n          <div><strong id=\"display-date\">Saturday, August 29</strong><span id=\"range-caption\">9:00 AM – 7:00 PM</span></div>\n          <div class=\"view-switch\" aria-label=\"Calendar range\">\n            <button class=\"active\" data-view=\"day\">Day</button><button data-view=\"week\">Week</button><button data-view=\"twoWeeks\">2 Weeks</button><button data-view=\"threeWeeks\">3 Weeks</button><button data-view=\"month\">Month</button>\n          </div>\n        </div>\n\n        <section id=\"status-summary\" class=\"summary\" aria-label=\"Today's appointment summary\"></section>\n        <section id=\"unassigned-queue\" class=\"unassigned-queue\" aria-label=\"Appointments needing assignment\"></section>\n        <section id=\"technician-overview\" class=\"technician-overview\" aria-label=\"Technician reward overview\"></section>\n\n        <section class=\"calendar-panel\">\n          <div class=\"calendar-toolbar\">\n            <div class=\"search-field\"><span>⌕</span><input id=\"technician-search\" type=\"search\" placeholder=\"Search customer or technician\"></div>\n            <select id=\"technician-filter\" aria-label=\"Technician visibility\"><option value=\"working\">Working today</option><option value=\"all\">All technicians</option></select>\n            <select id=\"mobile-technician\" aria-label=\"Choose technician\"></select>\n            <div class=\"legend\"><span><i class=\"dot completed\"></i>Completed</span><span><i class=\"dot upcoming\"></i>Upcoming</span><span><i class=\"dot pending\"></i>Pending</span></div>\n          </div>\n          <div id=\"calendar-grid\" class=\"calendar-viewport\" aria-label=\"Appointment calendar\"></div>\n        </section>\n      </div>\n      <div id=\"drawer-backdrop\" class=\"drawer-backdrop\"></div>\n      <aside id=\"drawer\" class=\"drawer\" aria-hidden=\"true\"></aside>\n      <div id=\"policy-backdrop\" class=\"drawer-backdrop\"></div>\n      <aside id=\"reward-settings-drawer\" class=\"policy-drawer\" aria-hidden=\"true\"></aside>\n    </section>";
    const sharedStyles = document.createElement('link');
    sharedStyles.rel = 'stylesheet';
    sharedStyles.href = '../assets/pos-turn-settings.css';
...
const formatTurnCredit = value => value.toLocaleString("en-US", {minimumFractionDigits: 1, maximumFractionDigits: 4});
...
const state = {
  ...
  rewardPolicy: { ...structuredClone(defaultRewardPolicy), turnCredit: window.NEXORA_TURN_SETTINGS.load().bookingTurnCredit, serviceWeights: window.NEXORA_TURN_SETTINGS.load().serviceWeights },
  policyDraft: null,
...
function weightedTurnFields(weights) {
  return window.NEXORA_TURN_SETTINGS.labels.map((label, index) => `<label><span data-service-range-label="${index}">${label} · service turns</span><input data-service-weight="${index}" type="number" min="0" step="any" required value="${weights[index]}"></label>`).join("");
}
...
function renderPolicyForm() {
  ...
  policyDrawer.innerHTML = `<div class="policy-head"><div><p class="eyebrow">OWNER ACCESS</p><h2>Booking incentive policy</h2><span>Reward completed appointment business and control its turn impact.</span></div><button class="close-policy" aria-label="Close reward settings">×</button></div>
    ...
    <section class="policy-section"><div class="policy-section-title"><span>3</span><div><strong>Period & turn credit</strong><small>Define the earning window and booking turn impact.</small></div></div><div class="field-grid"><label>Reward period<select id="reward-period"><option value="daily" ${policy.period === "daily" ? "selected" : ""}>Daily</option><option value="weekly" ${policy.period === "weekly" ? "selected" : ""}>Weekly</option><option value="biweekly" ${policy.period === "biweekly" ? "selected" : ""}>Biweekly</option><option value="monthly" ${policy.period === "monthly" ? "selected" : ""}>Monthly</option></select></label><label>Booking turn credit<input id="turn-credit" type="number" min="0" step="any" required value="${policy.turnCredit}"></label><label>Effective date<input id="effective-date" type="date" value="${policy.effectiveDate}"></label></div></section>
    <section class="policy-section" id="weighted-turn-settings"><div class="policy-section-title"><span>↔</span><div><strong>Weighted Turn Settings</strong><small>Shared with Front Desk → Turn Board.</small></div></div><p class="shared-turn-note">Set service turn credits by service value after discounts, excluding tips, tax, products, and gift-card payments. Booking turn credit is configured above; technician overrides still apply.</p><div class="shared-turn-grid">${weightedTurnFields(policy.serviceWeights)}</div><p class="shared-turn-note">Saving here updates Turn Board settings. Existing recorded turns stay unchanged. <a href="pos-front-desk-turn-board.html?settings=weighted-turns">Open Turn Board settings</a></p></section>
...
function readPolicyForm() {
  const policy = structuredClone(state.policyDraft || state.rewardPolicy); policy.scope = policyDrawer.querySelector('[name="scope"]:checked')?.value || policy.scope; policy.structure = policyDrawer.querySelector("[data-structure].active")?.dataset.structure || policy.structure; policy.calculation = policyDrawer.querySelector('[name="calculation"]:checked')?.value || policy.calculation; policy.period = $("#reward-period")?.value || policy.period; policy.turnCredit = window.NEXORA_TURN_SETTINGS.numberFrom($("#turn-credit")); policy.serviceWeights = [...policyDrawer.querySelectorAll("[data-service-weight]")].map(window.NEXORA_TURN_SETTINGS.numberFrom); policy.flatRate = Number($("#flat-rate")?.value ?? policy.flatRate); policy.effectiveDate = $("#effective-date")?.value || policy.effectiveDate;
...
function validatePolicyTurns(policy) {
  const error = window.NEXORA_TURN_SETTINGS.validate({bookingTurnCredit: policy.turnCredit, serviceWeights: policy.serviceWeights});
  if (error) return error;
  if (Object.values(policy.overrides).some(override => !Number.isFinite(override.turnCredit) || override.turnCredit < 0)) return "Enter a non-negative technician booking turn credit.";
  return "";
}

function updatePolicyPreview() {
  const draft = readPolicyForm();
  const turnError = validatePolicyTurns(draft);
  const validation = turnError ? {valid: false, message: turnError} : draft.structure === "tiers" ? validateTiers(draft.tiers) : {valid: true, message: "Policy is ready to save."};
  const amount = calculateReward(45, draft, {level: "Master"});
  $("#policy-preview").textContent = validation.valid ? `45 bookings → ${currency.format(amount)}` : "Check policy settings";
  $("#policy-validation").textContent = validation.message;
  $("#policy-validation").classList.toggle("error", !validation.valid);
  $("#save-policy").disabled = !validation.valid;
...
function savePolicy() {
  if (!updatePolicyPreview()) return;
  const policy = readPolicyForm();
  const result = window.NEXORA_TURN_SETTINGS.save({bookingTurnCredit: policy.turnCredit, serviceWeights: policy.serviceWeights});
  if (!result.ok) { $("#policy-validation").textContent = result.error; $("#policy-validation").classList.add("error"); return; }
  state.rewardPolicy = policy; state.assignmentPolicy = readAssignmentForm(); state.policyDraft = null; state.assignmentDraft = null; state.policyAudit.unshift({ action: `Policy updated · ${assignmentModeLabel()}`, actor: "Quarry Nails Bar Owner", time: "Aug 29, 2026 · 5:12 PM", effectiveDate: new Date(`${state.rewardPolicy.effectiveDate}T12:00:00`).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }) }); closeRewardSettings(); render(); }


window.NEXORA_TURN_SETTINGS.subscribe(settings => {
  state.rewardPolicy.turnCredit = settings.bookingTurnCredit;
  state.rewardPolicy.serviceWeights = settings.serviceWeights;
  if (state.policyDraft) {
    state.policyDraft.turnCredit = settings.bookingTurnCredit;
    state.policyDraft.serviceWeights = [...settings.serviceWeights];
  }
  if (policyDrawer.classList.contains("is-open")) {
    $("#turn-credit").value = settings.bookingTurnCredit;
    const weights = policyDrawer.querySelectorAll("[data-service-weight]");
    if (weights.length !== settings.serviceWeights.length) {
      const focusedIndex = [...weights].indexOf(policyDrawer.getRootNode().activeElement);
      const grid = policyDrawer.querySelector("#weighted-turn-settings .shared-turn-grid");
      grid.innerHTML = weightedTurnFields(settings.serviceWeights);
      if (focusedIndex >= 0) grid.querySelectorAll("[data-service-weight]")[Math.min(focusedIndex, settings.serviceWeights.length - 1)].focus();
    } else {
      weights.forEach((input, index) => { input.value = settings.serviceWeights[index]; });
      const labels = window.NEXORA_TURN_SETTINGS.labels;
      policyDrawer.querySelectorAll("[data-service-range-label]").forEach((label, index) => { label.textContent = labels[index] + " · service turns"; });
    }
    updatePolicyPreview();
  }
  renderTechnicianOverview();
});
...
restoreCalendarView();
if (new URLSearchParams(location.search).get("settings") === "booking-incentive") openRewardSettings();
