(function () {
  ...
  function mount(root, options) {
    ...
    function render() {
      ...
      $('[data-est-lines]').innerHTML = rows ? '<div class="estimate-line-heading"><span class="estimate-line-service"><span>Service</span><span>Unit price</span></span><span>Quantity</span><span></span></div>'+rows : '<p class="pos-muted">Select services to start an estimate.</p>';
      totals();
    }
