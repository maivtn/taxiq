(function () {
  ...
  const copy = {
    studioTitle:['Promotion Studio','Promotion Studio'], offersTab:['Promotions','Ưu đãi'], campaignsTab:['Paid Boost','Paid Boost'], reportsTab:['Results','Kết quả'],
    ...
    source:['Payment source','Nguồn thanh toán'], creditLink:['Manage Ads Credit','Quản lý Ads Credit'], kybLink:['Business verification (KYB)','Xác minh doanh nghiệp (KYB)'], creditHint:['Uses your existing Ads Credit. A budget is a spending cap, not an upfront charge. No automatic top-up.','Dùng Ads Credit hiện có. Ngân sách là hạn mức, không thu trước toàn bộ. Không tự động nạp.'],
    eligibility:['Before this campaign can run','Điều kiện trước khi chạy'], publicRequired:['Public approval is required.','Ưu đãi Public cần được duyệt.'], promotionRequired:['Enable the promotion before distribution.','Bật ưu đãi trước khi phân phối.'],
