(function () {
  ...
  const copy = {
    ...
    heroHint:['Show this promotion’s banners.','Hiển thị các banner của chương trình.'], public:['Search Deals listing','Hiển thị trên Search Deals'], free:['Free','Miễn phí'], publicHint:['Request an organic listing. Approval is required.','Yêu cầu hiển thị tự nhiên; cần được duyệt trước.'],
    publicNote:['Organic listings are free. Paid promotion is optional.','Hiển thị tự nhiên là miễn phí. Quảng cáo trả phí là tùy chọn.'], bannersSection:['04 / Banners & posters','04 / Banner & poster'],
