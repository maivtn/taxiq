...
function render(){
 ...
 if(selected&&!ticket){list.hidden=true;detail.hidden=false;detail.innerHTML='<button data-assignment-back>← Back to tickets</button><h2>Ticket not found</h2><p>This ticket is not available in this browser.</p>';return;}
...
root.addEventListener('click',event=>{
 ...
 if(b.hasAttribute('data-assignment-back'))navigate('tickets');
