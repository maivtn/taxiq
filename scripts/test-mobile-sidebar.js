...
const aiAdvisorIcon = sidebar?.querySelector('a[href="ai-advisor.html"] .taxiq-ai-icon');
const aiAdvisorIconBox = aiAdvisorIcon?.querySelector(".taxiq-ai-icon-box");
const aiAdvisorSparkle = aiAdvisorIcon?.querySelector(".taxiq-ai-sparkle");
const oldAiAdvisorIcon = sidebar?.querySelector('a[href="ai-advisor.html"] i');
...
assert(aiAdvisorIconBox, "AI Advisor icon should include the AI box mark");
assert(aiAdvisorSparkle, "AI Advisor icon should include a sparkle mark");
assert(!oldAiAdvisorIcon, "AI Advisor should no longer use a generic Font Awesome icon");
