...
const SOURCE_DIR = new URL('../../../docs/news/', import.meta.url);

const HTML_URL = new URL('./news-library.component.html', SOURCE_DIR);
const SCSS_URL = new URL('./news-library.component.scss', SOURCE_DIR);
const TS_URL = new URL('./news-library.component.ts', SOURCE_DIR);
