...
const {
  ...
  formatLocalDateTime,
  hasTechConflict,
} = require('../../../html/assets/pos-appointments-data.js');
...
test('seed module exposes a migration fixture provider', () => {
  assert.equal(typeof require('../../../html/assets/pos-appointments-data.js').createSeedBookings, 'function');
  assert.equal(typeof require('../../../html/assets/pos-appointments-data.js').createMigrationSeed, 'function');
});
