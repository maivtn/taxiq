...
const COMMUNITY_URL = new URL('./community.html', SOURCE_DIR);
const COMMUNITY_CSS_URL = new URL('../assets/community-page.css', SOURCE_DIR);
...
test('keeps Feed active by default and synchronizes submenu and page tabs', () => {
  const html = source();
  const runtime = readFileSync(new URL('../assets/community-page.js', SOURCE_DIR), 'utf8');
