...
function boot(query = '') {
  const dom=new JSDOM(readFileSync(new URL('./pos-front-desk.html', SOURCE_DIR),'utf8'),{url:'https://example.test/pages/pos-front-desk.html'+query,runScripts:'outside-only'});
  const w=dom.window;
