...
const BOOKING_URL = new URL('./booking-book-phase-1.html', SOURCE_DIR);
const SHELL_URL = new URL('../assets/nexora-shell.js', SOURCE_DIR);
const SMS_DASHBOARD_URL = new URL('./nexora-sms-dashboard.html', SOURCE_DIR);
const BRAND_LOGO_URL = new URL('../assets/nexora-logo.svg', SOURCE_DIR);
const CHANGE_ICON_URL = new URL('./change-icon.html', SOURCE_DIR);
