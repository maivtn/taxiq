...
const PAGE_URL = new URL('./nexora-review.html', SOURCE_DIR);
const CSS_URL = new URL('../assets/nexora-review.css', SOURCE_DIR);
const SHELL_CSS_URL = new URL('../assets/nexora-shell.css', SOURCE_DIR);
const JS_URL = new URL('../assets/nexora-review.js', SOURCE_DIR);
