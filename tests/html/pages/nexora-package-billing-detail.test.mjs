...
const PAGE_URL = new URL('./nexora-package-billing-detail.html', SOURCE_DIR);
const DETAIL_CSS_URL = new URL('../assets/nexora-package-billing-detail.css', SOURCE_DIR);
const DETAIL_JS_URL = new URL('../assets/nexora-package-billing-detail.js', SOURCE_DIR);
const BILLING_DATA_URL = new URL('../assets/nexora-package-billing-data.js', SOURCE_DIR);
const SHELL_JS_URL = new URL('../assets/nexora-shell.js', SOURCE_DIR);
const PDF_GENERATOR_URL = new URL('../../scripts/generate-nexora-billing-pdfs.py', SOURCE_DIR);
