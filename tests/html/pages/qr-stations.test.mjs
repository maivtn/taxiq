...
const PAGE_URL = new URL('./qr-stations.html', SOURCE_DIR);
const SHELL_URL = new URL('../assets/nexora-shell.js', SOURCE_DIR);
const CSS_URL = new URL('../assets/qr-stations.css', SOURCE_DIR);
const ONEQR_URL = new URL('../assets/qr-stations-oneqr.js', SOURCE_DIR);
