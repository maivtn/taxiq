...
const SOURCE = readFileSync(new URL('./booking-book-phase-1.html', SOURCE_DIR), 'utf8');
const APP_SHELL_SOURCE = readFileSync(new URL('./booking-book-src-app-shell.html', SOURCE_DIR), 'utf8');
