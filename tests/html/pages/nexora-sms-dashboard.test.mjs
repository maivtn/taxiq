...
const html = readFileSync(new URL('./nexora-sms-dashboard.html', SOURCE_DIR), 'utf8');
const shellSource = readFileSync(new URL('../assets/nexora-shell.js', SOURCE_DIR), 'utf8');
