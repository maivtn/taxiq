...
const SOURCE_DIR = new URL('../../../html/customer/', import.meta.url);

const SOURCE = readFileSync(new URL('./booking.html', SOURCE_DIR), 'utf8');
const PROMOTIONS_SOURCE = readFileSync(new URL('../assets/promotions-store.js', SOURCE_DIR), 'utf8');
